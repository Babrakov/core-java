...
public class OptionDialogFrame extends JFrame
{
   ...
   private Icon messageIcon = new ImageIcon(getClass().getResource("images/blue-ball.gif"));
   ...
   public Object[] getOptions()
   {
      ...
      else if (s.equals("Icon[]")) return new Icon[] { new ImageIcon(getClass().getResource("images/yellow-ball.gif")),
              new ImageIcon(getClass().getResource("images/blue-ball.gif")),
              new ImageIcon(getClass().getResource("images/red-ball.gif")) };
      else if (s.equals("Object[]")) return new Object[] { messageString, messageIcon,
            messageComponent, messageObject };
      else return null;
   }
