   ...
   {      
      ...
      */
      ...
      MenuItem cutItem = new MenuItem("Cut",
         new ImageView("v1ch13javafx/p11menu/cut.gif"));
      MenuItem copyItem = new MenuItem("Copy",
         new ImageView("v1ch13javafx/p11menu/copy.gif"));
      MenuItem pasteItem = new MenuItem("Paste",
         new ImageView("v1ch13javafx/p11menu/paste.gif"));
      ...
      Menu optionsMenu = new Menu("Options",
         new ImageView("v1ch13javafx/p11menu/options.gif"), readOnlyItem,
